...
var GameService = /** @class */ (function () {
    ...
    GameService.prototype.ping = function () {
        return 'received';
    };
    GameService.prototype.getGameInfo = function (gameId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios.get(this.baseurl + "game/" + gameId + "/gameInfo.json")
                    ...
                    case 2:
                        error_1 = _a.sent();
                        if (error_1.response.status === 500) {
    ...
    GameService.prototype.getScheduleForDate = function (date) {
        return __awaiter(this, void 0, void 0, function () {
            var error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios.get(this.baseurl + "scoreboard/basketball-men/d1/" + date + "/scoreboard.json")];
                    case 1: 
                    ...
                    case 2:
                        error_2 = _a.sent();
                        if (error_2.response.status === 500) {
